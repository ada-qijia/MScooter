    ...
    switch (_innerBackgroundStyle)
    {
        ...
        case WMGaugeViewInnerBackgroundStyleFlat:
        {
            ...
            */
            ...
            CGContextSetFillColorWithColor(context, CGRGB(206, 173, 04));//242, 99, 92));
            CGContextFillPath(context);
        }
        break;
...
- (void)drawScale:(CGContextRef)context
{
    ...
    for (int i = 0; i < totalTicks; i++)
    {
        ...
        if ((abs(mod - 0) < 0.000001) || (abs(mod - div) < 0.000001))
        {
            ...
            CGContextSetShadowWithColor(context, CGSizeMake(0.05, 0.05), _showScaleShadow ? 1.0 : 0.0,[[UIColor blackColor] CGColor]);
...
- (void)drawNeedle
{
    switch (_needleStyle)
    {
        ...
        case WMGaugeViewNeedleStyleFlatThin:
        {
            ...
            needleLayer.fillColor = CGRGB(206, 173, 04);//255, 104, 97);
            needleLayer.strokeColor = CGRGB(206, 173, 04);//255, 104, 97);
